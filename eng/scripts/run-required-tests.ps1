...
$defaultMinimums = @{
    ...
    ExecutionModeSelectorBoundaryTests = 3
    ExecutionModeSelectorTests = 7
    InterpreterFailureBoundaryTests = 4
    InterpreterPostCancellationBoundaryTests = 2
    InterpreterResultValidationCompatibilityTests = 5
    InterpreterResultValidationTests = 16
    InterpreterRunSummarySecurityValidationTests = 5
    ...
    ServerExtensionVoidProxyAllocationTests = 1
    ...
    ParameterReaderFormattableCompatibilityTests = 7
    ParameterReaderFormattableLifetimeTests = 3
    ...
    LoweringFailClosedInvariantTests = 3
    LoweringNegativeShapeMatrixTests = 5
    PluginAnalyzerHookChainTests = 9
    PluginAnalyzerHookChainCustomStageTests = 2
    PluginAnalyzerHookChainDiagnosticTests = 5
    PluginAnalyzerHookChainFileLocalDiagnosticsTests = 3
    PluginAnalyzerHookChainRemoteAliasTests = 8
    PluginAnalyzerHookChainRemoteControlFlowTests = 10
    PluginAnalyzerHookChainRemoteGeneratedChainTests = 8
    PluginAnalyzerHookChainRemoteNullForgivingTests = 3
    PluginAnalyzerHookChainRemoteRefAliasTests = 2
    PluginAnalyzerHookChainRemoteStagedUseTests = 7
    PluginAnalyzerHookChainResultRegistrationTests = 10
    ...
    InvokeAsyncGeneratedBuilderAliasTests = 2
    InvokeAsyncGeneratedCodeRegressionTests = 12
    InvokeAsyncGeneratedFallbackTypeInferenceTests = 2
    InvokeAsyncGeneratedFallbackHostBindingOverloadTests = 3
    InvokeAsyncCommonReturnInferenceTests = 7
    InvokeAsyncReturnConversionBoundaryTests = 21
    InvokeAsyncCollectionSinkConversionBoundaryTests = 5
    InvokeAsyncObjectSinkConversionBoundaryTests = 8
    InvokeAsyncRemainingSinkConversionBoundaryTests = 14
    InvokeAsyncFloatConversionBoundaryTests = 4
    InvokeAsyncSingleRuntimeOperationBoundaryTests = 30
    InvokeAsyncGeneratedFacadeContextualReturnTests = 13
    InvokeAsyncNamedLambdaManualIrTests = 6
    InvokeAsyncInheritedManualIrConversionTests = 1
    InvokeAsyncNullIrArgumentRecognitionTests = 10
    ...
    AnalyzerDefaultValueEmitterMatrixTests = 18
    PluginAnalyzerKernelMethodDescriptor = 33
    PluginServerFacadeRegressionTests = 3
    PluginServerMemberShapeRegressionTests = 17
    PluginServerSurpriseRegressionTests = 16
    PluginServerCollisionRegressionTests = 10
    ...
    PluginServerParameterContractSurpriseTests = 1
    ServerExtensionProxyAsyncTests = 4
    ServerExtensionProxyCancellationTests = 1
    ServerExtensionProxyNullableContractTests = 5
    ...
    RpcKernelNumericConversionGenerationTests = 5
    ...
    ServerExtensionSurpriseRegressionTests = 14
    ServerExtensionMethodRegressionTests = 6
    ServerExtensionDerivedDtoRegressionTests = 3
    ServerExtensionLoweringSurpriseTests = 8
    ServerExtensionBranchLocalRegressionTests = 2
    ...
    ServerExtensionClientProxySurpriseTests = 7
    ...
    ServerExtensionNullableDateTimeSupportTests = 7
    ...
    ServiceDefaultValueEmitterMatrixTests = 7
    ...
    Fix_CMP_0026_Tests = 9
    Fix_API_0027_Tests = 2
    PinnedHttpTransportTests = 3
    SafePinnedHttpResponseDisposalTests = 4
    ...
    QueryCustomContainsDispatchTests = 51
    ...
    MemberValueReaderInterfaceTests = 19
    MemberValueReaderCacheLifetimeTests = 6
    MemberValueReaderCacheAllocationTests = 6
    ...
    EventQueryStringRoutingAllocationTests = 12
    EventQueryStringRoutingTests = 16
