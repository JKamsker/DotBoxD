...
$defaultMinimums = @{
    ...
    ServerExtensionGeneratedDtoReaderRegressionTests = 10
    ServerExtensionClientNoPayloadValidationTests = 1
    ServerExtensionClientContractSurpriseTests = 2
    ServerExtensionClientDecodeSurpriseTests = 2
    ServerExtensionClientProxySurpriseTests = 1
    KernelRpcMarshallerSurpriseTests = 19
