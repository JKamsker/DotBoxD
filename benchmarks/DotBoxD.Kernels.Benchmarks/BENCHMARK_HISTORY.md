...
| Kernel RPC generated empty list writers | this commit | `--probe-kernel-rpc-value-list-writer` | Generated counted list writers now use `Array.Empty<KernelRpcValue>()` for zero-count indexed and counted-enumerable inputs. The 1M empty indexed writer probe improved from 16.0 ms and 24,000,040 B to 1.6 ms and 40 B; the empty counted-enumerable branch improved from 13.7 ms and 24,000,072 B to 8.6 ms and 40 B. |
