...
internal static class PeerInboundTestSupport
{
    internal static readonly TimeSpan ShortTimeout = TimeSpan.FromSeconds(30);

    internal static MessagePackRpcSerializer NewSerializer() => new();

    internal static async Task<RpcResponse> ReadErrorResponseAsync(
        IRpcChannel channel,
    ...
    internal static Payload CreateRequestFrame(ISerializer serializer, int messageId, string service, string method) =>
    ...
    internal static Payload RentFrame(byte[] bytes)
    {
    ...
    internal static Payload CopyFrame(Payload source)
    {
    ...
    internal static async Task WaitForPayloadDisposedAsync(Payload payload)
    {
    ...
    internal sealed class EchoDispatcher : IServiceDispatcher
    {
    ...
    internal sealed class NotFoundDispatcher : IServiceDispatcher
    {
    ...
    internal sealed class ThrowingDispatcher(string message) : IServiceDispatcher
    {
    ...
    internal sealed class CancelAwareDispatcher : IServiceDispatcher
    {
    ...
    internal sealed class SendFailureException : Exception
    {
    ...
    internal sealed class SendFailingConnection : IRpcChannel
    {
