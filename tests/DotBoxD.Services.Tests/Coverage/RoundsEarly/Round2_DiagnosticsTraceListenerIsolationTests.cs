...
/// <c>InternalsVisibleTo("DotBoxD.Services.Tests")</c> on DotBoxD.Services. The test exercises it directly.
/// </para>
///
/// <para>
...
public sealed class Round2_DiagnosticsTraceListenerIsolationTests
{
    ...
    {
        // Report's catch logs: $"DotBoxD diagnostic handler failed: {subscriberError}".
        private const string FallbackLogPrefix = "DotBoxD diagnostic handler failed";
