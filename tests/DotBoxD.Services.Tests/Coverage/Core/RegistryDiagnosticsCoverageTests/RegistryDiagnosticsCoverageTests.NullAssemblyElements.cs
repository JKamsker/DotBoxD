...
public sealed partial class GeneratedServiceRegistryCoverageTests
{
    ...
    public void RegisterServices_NullAssemblyElement_ReportsAssembliesParameter()
    {
        ...
        var thrown = Record.Exception(() => GeneratedServiceRegistry.RegisterServices(assemblies, sink));
    ...
    public void RegisterGeneratedServices_NullAssemblyElement_ReportsAssembliesParameter()
    {
        ...
        var thrown = Record.Exception(() => GeneratedServiceRegistry.RegisterGeneratedServices(assemblies, sink));
        var ex = Assert.IsAssignableFrom<ArgumentException>(thrown);
