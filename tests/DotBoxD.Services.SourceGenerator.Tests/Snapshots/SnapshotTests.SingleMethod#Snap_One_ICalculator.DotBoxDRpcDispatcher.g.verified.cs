...
#pragma warning restore CS1998
        {
            switch (method)
            {
                ...
                default:
                    throw new global::DotBoxD.Services.Exceptions.DotBoxDRpcNotFoundException("Method '" + method + "' not found on service 'ICalculator'.", global::DotBoxD.Services.Exceptions.DotBoxDRpcNotFoundException.NotFoundKind.Method);
            }
        }
...
#pragma warning restore CS1998
        {
            ...
            {
                throw new global::DotBoxD.Services.Exceptions.DotBoxDRpcNotFoundException("Instance '" + instanceId + "' not found for service 'ICalculator'.", global::DotBoxD.Services.Exceptions.DotBoxDRpcNotFoundException.NotFoundKind.Instance);
            }
            switch (method)
            {
                case "AddAsync":
