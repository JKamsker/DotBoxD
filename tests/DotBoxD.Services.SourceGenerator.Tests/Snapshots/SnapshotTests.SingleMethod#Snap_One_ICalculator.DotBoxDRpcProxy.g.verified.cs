...
namespace Snap.One
{
    ...
    public sealed class CalculatorProxy : global::Snap.One.ICalculator, global::Snap.One.ICalculatorAsync
    {
        ...
        public global::System.Threading.Tasks.Task<int> AddAsync(int a, int b, global::System.Threading.CancellationToken ct = default)
        {
            try
            {
                return __dotboxd_observeCallerCancellationAsync((this._instanceId is null ? this._invoker.InvokeAsync<(int, int), int>("ICalculator", "AddAsync", (a, b), ct) : this._invoker.InvokeOnInstanceAsync<(int, int), int>("ICalculator", this._instanceId!, "AddAsync", (a, b), ct)), ct);
            }
