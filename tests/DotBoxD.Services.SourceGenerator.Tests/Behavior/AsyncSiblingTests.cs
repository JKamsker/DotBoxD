...
public class AsyncSiblingTests
{
    ...
    /// sibling form <c>FooAsync</c> would collide. The generator surfaces DBXS004
    ...
    private sealed class Recorder : global::DotBoxD.Services.Server.IRpcInvoker
    {
    ...
    /// </summary>
    private sealed class DeferredRecorder : global::DotBoxD.Services.Server.IRpcInvoker
    {
