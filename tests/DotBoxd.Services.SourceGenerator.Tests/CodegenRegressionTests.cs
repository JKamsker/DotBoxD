...
public class CodegenRegressionTests
{
    ...
    private sealed class ValueReturningClient : global::DotBoxd.Services.IRpcInvoker
    {
    ...
    private sealed class OverloadProbeClient : global::DotBoxd.Services.IRpcInvoker
    {
