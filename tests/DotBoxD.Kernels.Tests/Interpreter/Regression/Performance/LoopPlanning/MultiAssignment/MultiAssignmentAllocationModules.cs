...
internal static class MultiAssignmentAllocationModules
{
    public const string ForRange = """
    {
      "id": "i32-multi-assignment-for-allocation",
      "version": "1.0.0",
      "functions": [{
        "id": "main",
    ...
    {
      "id": "i32-multi-assignment-while-allocation",
      "version": "1.0.0",
      "functions": [{
        "id": "main",
        "visibility": "entrypoint",
    ...
    {
      "id": "i32-multi-assignment-while-no-loop-control",
      "version": "1.0.0",
      "functions": [{
        "id": "main",
        "visibility": "entrypoint",
