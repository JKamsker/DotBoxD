...
public sealed class PluginAnalyzerForbiddenApiRuntimeStateReachabilityTests
{
    ...
    [Fact]
    public async Task Reports_gc_latency_mode_mutation_from_event_kernel()
    {
        var diagnostics = await AnalyzeAsync("""
            ...
            namespace Sample
            {
                ...
                [Plugin("gcsettings-runtime-state")]
        ...
        Assert.True(
            message.Contains("System.Runtime.GCSettings", StringComparison.Ordinal)
            || message.Contains("System.Runtime.GCLatencyMode", StringComparison.Ordinal),
            message);
    }
