...
public sealed class PluginAnalyzerForbiddenApiFixedReachabilityTests
{
    private static readonly CSharpParseOptions ParseOptions =
        CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Preview);

    [Fact]
    public async Task Reports_forbidden_helper_reached_through_fixed_pinnable_reference()
    {
        const string source = """
            namespace Sample
            {
    ...
    private static CSharpCompilation CreateCompilation(string source)
    {
        ...
        return CSharpCompilation.Create(
            "DotBoxDPluginAnalyzerFixedReachabilityTest",
            [syntaxTree],
