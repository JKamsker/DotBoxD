...
public sealed class PluginAnalyzerForbiddenApiHostAclReachabilityTests
{
    ...
    private static string Source(string statement)
        => $$"""
            ...
            namespace Sample
            {
                ...
                [Plugin("host-acl-leak")]
                public sealed class HostAclKernel : IEventKernel<string>
                {
    ...
    private static CSharpCompilation CreateCompilation(string source)
    {
        ...
        return CSharpCompilation.Create(
            "DotBoxDPluginAnalyzerHostAclReachabilityTest",
            [syntaxTree],
