...
public sealed class PluginAnalyzerForbiddenApiModuleInitializerReachabilityTests
{
    private static readonly CSharpParseOptions ParseOptions =
        CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.Preview);

    [Fact]
    public async Task Reports_forbidden_api_reached_through_module_initializer()
    {
        const string source = """
            namespace Sample
            {
                ...
                [Plugin("module-initializer-leak")]
                public sealed class ModuleInitializerKernel : IEventKernel<string>
                {
    ...
    private static CSharpCompilation CreateCompilation(string source)
    {
        ...
        return CSharpCompilation.Create(
            "DotBoxDPluginAnalyzerModuleInitializerReachabilityTest",
            [syntaxTree],
