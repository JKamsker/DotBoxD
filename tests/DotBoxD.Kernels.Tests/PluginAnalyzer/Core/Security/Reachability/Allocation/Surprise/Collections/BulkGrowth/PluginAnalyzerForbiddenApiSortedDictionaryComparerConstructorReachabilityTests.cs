...
public sealed class PluginAnalyzerForbiddenApiSortedDictionaryComparerConstructorReachabilityTests
{
    [Fact]
    public async Task Reports_unbounded_sorted_dictionary_dictionary_and_comparer_constructor_static_initializer()
    {
        var diagnostics = await PluginAnalyzerCapacityTestHarness.AnalyzeAsync(
            Source("new SortedDictionary<int, int>(Source, Comparer<int>.Default)"),
            "DotBoxDPluginAnalyzerSortedDictionaryComparerConstructorReachabilityTest");
    ...
    [Fact]
    public async Task Does_not_report_comparer_only_sorted_dictionary_constructor_static_initializer()
    {
        var diagnostics = await PluginAnalyzerCapacityTestHarness.AnalyzeAsync(
            Source("new SortedDictionary<int, int>(Comparer<int>.Default)"),
            "DotBoxDPluginAnalyzerComparerOnlySortedDictionaryConstructorReachabilityTest");
    ...
    private static string Source(string initializer)
        => $$"""
            ...
            namespace Sample
            {
                ...
                [Plugin("sorted-dictionary-comparer-constructor-reachability")]
                public sealed class SortedDictionaryComparerConstructorKernel : IEventKernel<string>
                {
