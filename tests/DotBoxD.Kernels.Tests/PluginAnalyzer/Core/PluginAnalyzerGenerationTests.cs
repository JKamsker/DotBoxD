...
public sealed class PluginAnalyzerGenerationTests
{
    ...
    public void Generator_uses_interface_method_implementation_not_first_same_named_method()
    {
        ...
        Assert.Contains("new global::DotBoxD.Kernels.IfStatement(Bool(true)", generated);
        Assert.DoesNotContain("new global::DotBoxD.Kernels.IfStatement(Bool(false)", generated);
    }
    ...
    public void Generator_preserves_constant_live_setting_default_expressions()
    {
        ...
        var generated = Assert.Single(result.GeneratedTrees).GetText().ToString();
        Assert.Contains("new global::DotBoxD.Plugins.LiveSettingDefinition(\"MinDamage\", \"int\", 100)", generated);
        Assert.Contains("new global::DotBoxD.Plugins.LiveSettingDefinition(\"Offset\", \"int\", -1)", generated);
    }
