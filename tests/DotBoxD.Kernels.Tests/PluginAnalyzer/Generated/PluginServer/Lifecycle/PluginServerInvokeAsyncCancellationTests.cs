...
{
    [Fact]
    public async Task Generated_plugin_server_InvokeAsync_observes_cancellation_before_decoding_response()
    {
        var (_, outputCompilation) = PluginServerGenerationTestDriver.Run(BaseServerSource(extraPluginTypes: """
                ...
                {
                    public static async Task<InvokeCancellationProbeResult> RunAsync()
                    {
                        using var cts = new CancellationTokenSource();
                        var control = new RecordingControlService(cts);
                        ...
                        return new InvokeCancellationProbeResult(
                ...
                public sealed class RecordingControlService : Regression.Game.Ipc.IGamePluginControlService
                {
                    ...
                    public RecordingControlService(CancellationTokenSource cts)
                        => _cts = cts;
                    ...
                    public ValueTask<string> InstallServerExtensionAsync(
                        ...
                        ValueTask.FromResult("anon-probe");
        ...
        var probe = assembly.GetType("Regression.Plugin.InvokeCancellationProbe", throwOnError: true)!;
