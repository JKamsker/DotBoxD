...
public sealed class PluginAnalyzerRangeCompletenessTests
{
    ...
    public void Generator_preserves_supported_numeric_range_overloads()
    {
        ...
        Assert.Contains("new global::DotBoxD.Plugins.LiveSettingDefinition(\"MinDamage\", \"int\", 50, 0, 100)", generated);
        Assert.Contains("new global::DotBoxD.Plugins.LiveSettingDefinition(\"Ratio\", \"double\", 1.5D, 0.5D, 2.5D)", generated);
        Assert.Contains("new global::DotBoxD.Plugins.LiveSettingDefinition(\"Sequence\", \"long\", 7L, 1L, 9L)", generated);
        Assert.Contains("new global::DotBoxD.Plugins.LiveSettingDefinition(\"LargeSequence\", \"long\", 7L, 1L, 10000000000L)", generated);
    }
    ...
    private static GeneratorDriverRunResult RunGenerator(string source)
    {
        var compilation = CSharpCompilation.Create(
            "DotBoxDPluginRangeCompletenessTest",
