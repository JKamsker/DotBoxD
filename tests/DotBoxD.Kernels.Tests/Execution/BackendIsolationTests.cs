...
public sealed class BackendIsolationTests
{
    ...
    public void Interpreter_assembly_has_no_compiler_or_verifier_dependency()
    {
        ...
        Assert.DoesNotContain("DotBoxD.Kernels.Compiler", references);
        Assert.DoesNotContain("DotBoxD.Kernels.Verifier", references);
    }
    ...
    public void Compiler_assembly_has_no_interpreter_dependency()
    {
        ...
        Assert.DoesNotContain("DotBoxD.Kernels.Interpreter", references);
    }
