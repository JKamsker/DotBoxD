...
public sealed class CompiledSideEffectQuotaParityTests
{
    ...
    private static SandboxPolicy QuotaParityPurePolicy(int maxHostCalls, long maxFuel)
        => SandboxPolicyBuilder.Create()
            .WithFuel(maxFuel)
            .WithMaxHostCalls(maxHostCalls)
            .Build();

    private static SandboxPolicy QuotaParityMessagePolicy(int maxHostCalls, long maxFuel)
        => SandboxPolicyBuilder.Create()
    ...
    /// <summary>Single math.abs call returning abs(0).</summary>
    private static string QuotaParitySingleAbsJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
    ...
    /// <summary>Two sequential math.abs calls — exercises per-call quota limits.</summary>
    private static string QuotaParityDoubleAbsJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
    ...
    /// <summary>Pure computation with multiple arithmetic ops to burn fuel.</summary>
    private static string QuotaParityPureComputeJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
    ...
    /// <summary>Single log.info call.</summary>
    private static string QuotaParityLogJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
    ...
    /// <summary>Two sequential log calls — exercises per-log-event quota limits.</summary>
    private static string QuotaParityDoubleLogJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
    ...
    /// <summary>Single host.message.send to "player-1" / "hello".</summary>
    private static string QuotaParitySingleSendJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
    ...
    /// <summary>Two sequential host.message.send calls.</summary>
    private static string QuotaParityDoubleSendJson(string id)
        => $$"""
        {
          "id": "{{id}}",
          "version": "1.0.0",
