...
public sealed class RegistrationAccumulatorObsoleteAttributeIdentitySurpriseTests
{
    [Fact]
    public void Foreign_obsolete_attribute_does_not_change_generated_accumulator_contract()
    {
        var result = RunGenerator(
            ...
            {
                [foreignObsolete::System.Obsolete("FOREIGN_REG")]
            ...
            """,
            CreateForeignObsoleteReference());
        ...
        Assert.DoesNotContain("ObsoleteAttribute", foreignSource, StringComparison.Ordinal);
        Assert.DoesNotContain("FOREIGN_REG", foreignSource, StringComparison.Ordinal);
        Assert.Contains(
            "[global::System.ObsoleteAttribute(\"REAL_REG\")]",
            realSource,
    ...
    private static GeneratorDriverRunResult RunGenerator(string source, MetadataReference foreignReference)
    {
        ...
        var compilation = CSharpCompilation.Create(
            "RegistrationAccumulatorObsoleteAttributeIdentityTests",
    ...
    private static MetadataReference CreateForeignObsoleteReference()
    {
        var compilation = CSharpCompilation.Create(
            "ForeignObsoleteAttribute",
        ...
        return MetadataReference.CreateFromImage(
            assembly.ToArray(),
            new MetadataReferenceProperties(MetadataImageKind.Assembly, aliases: ["foreignObsolete"]));
    }
