...
public sealed class VerifierGeneratedShapeTests
{
    ...
    [InlineData("DotBoxD.Kernels.Generated.NotModule_0123456789abcdef")]
    [InlineData("DotBoxD.Kernels.Generated.Module_nothex")]
    public async Task Verifier_rejects_unexpected_generated_type_names(string typeName)
    {
        ...
        Assert.Contains(result.Diagnostics, d =>
            ...
            d.Message.Contains("DotBoxD.Kernels.Generated.Module_<16-hex-hash>", StringComparison.Ordinal));
    }
