...
[kernels.md](kernels.md)). That single fact drives every design choice on this page:
...
allowlist, not host API.) The same guarantee extends to [pushdown](pushdown.md) server extensions, which
