---
title: 'Sandbox caveats — what is and isn''t a boundary'
---
...
capability *you* implement and trust → a plain [Service](/concepts/services/) RPC, which needs no
...
See [`SECURITY.md`](https://github.com/JKamsker/DotBoxD/blob/main/SECURITY.md) for reporting, and the full threat model under
