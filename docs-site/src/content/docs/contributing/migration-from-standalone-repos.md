---
title: 'Migration: from ShaRPC + Safe-IR to DotBoxD'
description: 'DotBoxD is the merger of two formerly standalone repositories into one contract-first runtime:'
---
...
See [`CONTRIBUTING.md`](https://github.com/JKamsker/DotBoxD/blob/main/CONTRIBUTING.md) for the full CI gate list (security-boundary suite,
