---
title: 'DotBoxD WebSocket Transport Setup Guide'
description: 'This guide covers implementing and using WebSocket transport with DotBoxD. WebSocket transport is ideal for browser clients, Unity WebGL builds, and…'
---
...
- [Quick Start Guide](/channels/quick-start/) - Basic DotBoxD setup
- [Unity Integration](/channels/unity-integration/) - Full Unity setup including WebGL
- [API Reference](/channels/api-reference/) - Detailed API documentation
