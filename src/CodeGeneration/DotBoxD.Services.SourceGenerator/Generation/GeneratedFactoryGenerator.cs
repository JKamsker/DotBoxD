...
internal static class GeneratedFactoryGenerator
{
        ...
        CancellationToken ct = default)
    {
        ...
        foreach (var externAlias in GetExternAliases(services, ct))
        {
    ...
    private static HashSet<string> GetExternAliases(EquatableArray<ServiceModel> services, CancellationToken ct)
    {
        var aliases = new HashSet<string>(System.StringComparer.Ordinal);
        foreach (var service in services.Array)
        {
            ct.ThrowIfCancellationRequested();
            foreach (var alias in service.ExternAliases.Array)
            {
                aliases.Add(alias);
            }
        }
