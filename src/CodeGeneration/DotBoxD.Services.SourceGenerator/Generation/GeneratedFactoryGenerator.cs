...
internal static class GeneratedFactoryGenerator
{
        ...
        CancellationToken ct = default)
    {
        ...
        AppendExternAliases(sb, services);
    ...
    private static void AppendExternAliases(StringBuilder sb, EquatableArray<ServiceModel> services)
    {
        ...
        foreach (var service in services.Array)
        {
            ...
            {
                aliases.Add(externAlias);
            }
        }

        foreach (var externAlias in aliases)
        {
