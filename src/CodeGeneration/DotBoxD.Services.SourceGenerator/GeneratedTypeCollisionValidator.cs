...
internal static class GeneratedTypeCollisionValidator
{
        ...
        CancellationToken ct)
    {
        ...
        var extensions = new ExistingTypeKey("DotBoxD.Services.Generated", "DotBoxDGeneratedExtensions", 0);
        if (existingTypes.Contains(extensions, ct))
        {
            return RejectedService(
                model,
                "generated extension type 'DotBoxD.Services.Generated.DotBoxDGeneratedExtensions' would collide with an existing type",
                extensions);
        }

        var factory = new ExistingTypeKey("DotBoxD.Services.Generated", "DotBoxDGenerated", 0);
        if (existingTypes.Contains(factory, ct))
        {
            return RejectedService(
                model,
                "generated factory type 'DotBoxD.Services.Generated.DotBoxDGenerated' would collide with an existing type",
                factory);
        }
