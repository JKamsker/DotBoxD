...
internal static class IdentifierHelpers
{
    ...
    public static string QualifyTypeName(string @namespace, string typeName)
    {
        ...
        {
            return ServicesGeneratorTypeNames.GlobalPrefix + escapedTypeName;
        }

        return ServicesGeneratorTypeNames.GlobalPrefix + EscapeNamespace(@namespace) + "." + escapedTypeName;
    }
}
