...
/// names/arities the user already declared (so they are not re-emitted), and whether it satisfies the
...
internal sealed record HookResultModel(
    ...
    EquatableArray<HookResultExistingMember> ExistingMembers,
    bool HasSuccess,
    bool HasReason,
