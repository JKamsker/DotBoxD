...
internal static class HookFireAsyncExtensionEmitter
{
    ...
    private static string Build(IEnumerable<HookFireAsyncModel> models)
    {
        ...
        builder.Append("namespace ").Append(HookFireAsyncExtensionNames.RuntimeNamespace).AppendLine(";");
        builder.AppendLine();
        ...
        builder.Append(classAccessibility).Append(" static class ")
            .AppendLine(HookFireAsyncExtensionNames.HelperTypeName);
        builder.AppendLine("{");
        foreach (var model in models)
        {
