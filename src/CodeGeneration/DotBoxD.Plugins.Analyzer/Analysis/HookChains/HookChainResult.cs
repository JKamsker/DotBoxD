...
/// <c>UseGeneratedChain</c>. Interception is null only when the call site has no interceptable
/// location — the package still generates.
/// </summary>
...
internal sealed record HookChainInterception(
    ...
    string HandlerElementTypeFullName,
