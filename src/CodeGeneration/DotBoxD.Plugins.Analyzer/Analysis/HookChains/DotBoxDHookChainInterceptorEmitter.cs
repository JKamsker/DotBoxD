...
{
    public const string InterceptorNamespace = "DotBoxD.Plugins.Generated";
    ...
    private static string BuildInterceptors(ImmutableArray<HookChainInterception> interceptions)
    {
        ...
        for (var i = 0; i < interceptions.Length; i++)
        {
            ...
            var handlerType = interception.HandlerIsAction
                ? $"global::System.Action<{interception.EventTypeFullName}, global::DotBoxD.Abstractions.HookContext>"
                : $"global::System.Func<{interception.EventTypeFullName}, global::DotBoxD.Abstractions.HookContext, global::System.Threading.Tasks.ValueTask>";

            builder.Append("        ").AppendLine(interception.AttributeSyntax);
            builder.Append("        public static global::DotBoxD.Plugins.HookPipeline<")
                .Append(interception.EventTypeFullName)
                .Append("> Intercept_")
                .Append(i.ToString(System.Globalization.CultureInfo.InvariantCulture))
                .AppendLine("(");
            builder.Append("            this global::DotBoxD.Plugins.HookPipeline<")
                .Append(interception.EventTypeFullName)
                .AppendLine("> pipeline,");
