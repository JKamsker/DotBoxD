...
public static class PluginDiagnosticCodes
{
    ...
    [
        ...
        new("DBXK045", PluginDiagnosticPhase.PackageValidation, PluginDiagnosticAudience.PluginAuthor,
            "The manifest requiredCapabilities list contains a null entry.",
            "The manifest was constructed in memory with a null capability id that cannot be validated against the verified plan.",
            "Regenerate the package so requiredCapabilities contains only non-null capability ids."),
