...
public static class PluginDiagnosticCodes
{
    ...
    [
        ...
        new("DBXK045", PluginDiagnosticPhase.PackageValidation, PluginDiagnosticAudience.PluginAuthor,
            "A required plugin package collection contains a null entry or missing collection.",
            "The manifest requiredCapabilities list, module capabilityRequests, or module functions collection was constructed with null data.",
            "Regenerate the package, or remove null requiredCapabilities, capabilityRequests, and functions entries before calling the install boundary."),
        ...
        new("DBXK051", PluginDiagnosticPhase.PackageValidation, PluginDiagnosticAudience.PluginAuthor,
            "A manifest required capability entry is a wildcard instead of a concrete capability id.",
            "The manifest requiredCapabilities list contains an entry such as event.read.*.",
            "Regenerate the package so requiredCapabilities contains only concrete capability ids."),
        new("DBXK052", PluginDiagnosticPhase.PackageValidation, PluginDiagnosticAudience.PluginAuthor,
            "A manifest or module required capability entry is not a valid capability id.",
            "A requiredCapabilities entry contains an empty dotted segment, such as event.read.bad..id.",
            "Regenerate the package so requiredCapabilities contains only valid concrete capability ids."),
