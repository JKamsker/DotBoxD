...
public static class PluginDiagnosticCodes
{
    ...
    [
        ...
        new("DBXK062", PluginDiagnosticPhase.RuntimeEntrypoint, PluginDiagnosticAudience.PluginAuthor,
            ...
            "InvokeKernel(lambda) was invoked at runtime without the DotBoxD.Kernels analyzer lowering it (analyzer not referenced, or an unsupported construct in the chain).",
            "Reference DotBoxD.Plugins.Analyzer so InvokeKernel chains are lowered, or bind a kernel class with UseKernel/Register instead."),
