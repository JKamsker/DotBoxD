...
public static class PluginDiagnosticCodes
{
    ...
    [
        ...
        new("DBXK045", PluginDiagnosticPhase.PackageValidation, PluginDiagnosticAudience.PluginAuthor,
            "The module contains a null entry in a required collection.",
            "An in-memory package supplied a null capabilityRequests or functions element.",
            "Regenerate the package, or remove null entries before calling the install boundary."),
